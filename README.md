...
This repository implements Elliptical Slice Sampling (ESS) and its multiproposal generalization (MESS) for Bayesian inference with Gaussian priors and non-Gaussian likelihoods. It accompanies the pre-print "Multproposal Elliptical Slice Sampling" by Senn et al. (2026).
